...
# the following uses constant seawater density of 1025 kg/m3
...
# need to find an equation to calcuate density based on CTD bottle data temperature, salinity, pressure for bottles plotted here for discrete Winkler oxygen
# consider adjusting to seawater density of 1027.7 kg/m3 which is an approximate average density using an online calculator
